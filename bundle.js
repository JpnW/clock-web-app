...
/******/ 	var hotCurrentHash = "0e56a00c1047382bddc3"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  background-color: #d3d3d3;\n  color: #fff; }\n  body main {\n    margin: 100px auto;\n    background: #000;\n    width: 500px; }\n    body main .option-buttons {\n      font-size: 22px;\n      width: 100%; }\n      body main .option-buttons > button {\n        width: 50%;\n        padding: 20px;\n        color: #fff;\n        background: #555; }\n        body main .option-buttons > button:hover {\n          background: #333;\n          cursor: pointer; }\n        body main .option-buttons > button:active {\n          background: #222; }\n      body main .option-buttons > button.selected {\n        background: #f55; }\n    body main .clock .analog-container {\n      width: 60%;\n      margin: 20px 20%; }\n      body main .clock .analog-container .circle {\n        fill: #fff; }\n      body main .clock .analog-container .hr, body main .clock .analog-container .min, body main .clock .analog-container .sec {\n        stroke-width: 1px;\n        fill: #333;\n        stroke: #555; }\n      body main .clock .analog-container .sec {\n        stroke: #f55; }\n    body main .clock > h1 {\n      text-align: center;\n      padding-bottom: 30px;\n      font-size: 40px; }\n    body main .stopwatch > h1 {\n      font-size: 88px;\n      text-align: center; }\n    body main .stopwatch .stopwatch-buttons {\n      margin: 0 auto;\n      width: 300px; }\n      body main .stopwatch .stopwatch-buttons > button {\n        font-size: 16px;\n        padding: 10px;\n        width: 150px;\n        margin-bottom: 50px;\n        background: #fff; }\n        body main .stopwatch .stopwatch-buttons > button:hover {\n          background: #d3d3d3;\n          cursor: pointer; }\n        body main .stopwatch .stopwatch-buttons > button:active {\n          background: #555; }\n      body main .stopwatch .stopwatch-buttons .disabled {\n        display: none; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Clock = __webpack_require__(240);
	...
	var Root = function (_React$Component) {
	  ...
	  function Root() {
	    ...
	    _this.state = { option: 'clock', showStopwatchButton: 'start-button', currentTime: null, lastStoppedTime: 0, diff: 0 };
	    ...
	    _this._handleStopClick = _this._handleStopClick.bind(_this);
	    _this._handleResetClick = _this._handleResetClick.bind(_this);
	    _this._toggleOptionClassName = _this._toggleOptionClassName.bind(_this);
	    _this._toggleStopwatchButtonClassName = _this._toggleStopwatchButtonClassName.bind(_this);
	    _this.requestStopwatchId = null;
	    return _this;
	  }
	  ...
	  _createClass(Root, [{
	    ...
	    key: '_tick',
	    value: function _tick(start) {
	      var _this2 = this;
	
	      this.requestStopwatchId = window.requestAnimationFrame(function () {
	        var current = Date.now();
	        var diff = current - start + _this2.state.lastStoppedTime;
	    ...
	    value: function _handleStartClick() {
	      var start = Date.now();
	      this._tick(start);
	    ...
	    key: '_handleResetClick',
	    value: function _handleResetClick() {
	      window.cancelAnimationFrame(this.requestStopwatchId);
	    ...
	    key: '_toggleOptionClassName',
	    value: function _toggleOptionClassName(className) {
	    ...
	    key: '_toggleStopwatchButtonClassName',
	    value: function _toggleStopwatchButtonClassName(className) {
	    ...
	    value: function render() {
	      ...
	      var element = void 0;
	      if (option == 'clock') {
	        element = _react2.default.createElement(_Clock2.default, { currentTime: this.state.currentTime });
	      } else if (option === 'stopwatch') {
	        element = _react2.default.createElement(_Stopwatch2.default, { diff: this.state.diff,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: this._toggleOptionClassName('clock'),
	              onClick: this._handleOptionClick.bind(this, 'clock') },
	            'Clock'
	          ),
	          _react2.default.createElement(
	            'button',
	            { className: this._toggleOptionClassName('stopwatch'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Analog = __webpack_require__(242);
	...
	var Clock = function (_React$Component) {
	  ...
	  function Clock(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Clock).call(this, props));
	  }
	  ...
	  _createClass(Clock, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'section',
	        { className: 'clock' },
	        _react2.default.createElement(_Analog2.default, { currentTime: this.props.currentTime }),
	        _react2.default.createElement(
	          'h1',
	          null,
	          (0, _utils.formatTime)(this.props.currentTime)
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Analog = function (_React$Component) {
	  _inherits(Analog, _React$Component);
	
	  function Analog(props) {
	    _classCallCheck(this, Analog);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Analog).call(this, props));
	
	    _this._getAnalogUpdate = _this._getAnalogUpdate.bind(_this);
	    _this.requestAnalogUpdateId = null;
	    return _this;
	  }
	
	  _createClass(Analog, [{
	    key: '_getAnalogUpdate',
	    value: function _getAnalogUpdate() {
	      var _this2 = this;
	
	      var repeat = function repeat(el, deg) {
	        _this2.refs[el].setAttribute('transform', 'rotate(' + deg + ' 50 50)');
	      };
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'analog-container' },
	        _react2.default.createElement(
	          'svg',
	          { className: 'analog', viewBox: '0 0 100 100' },
	          _react2.default.createElement('circle', { className: 'circle', cx: '50', cy: '50', r: '45' }),
	          _react2.default.createElement(
	            'g',
	            null,
	            _react2.default.createElement('rect', { ref: 'hr', className: 'hr', x: '47.5', y: '12.5', width: '5', height: '40', rx: '2.5', ry: '2.55' }),
	            _react2.default.createElement('rect', { ref: 'min', className: 'min', x: '48.5', y: '12.5', width: '3', height: '40', rx: '2', ry: '2' }),
	            _react2.default.createElement('line', { ref: 'sec', className: 'sec', x1: '50', y1: '50', x2: '50', y2: '16' })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stopwatch = function (_React$Component) {
	  ...
	  function Stopwatch(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Stopwatch).call(this, props));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          (0, _utils.formatStopwatch)(this.props.diff)
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: this.props._toggleStopwatchButtonClassName('start-button'),
	              onClick: this.props._handleStartClick },
	            'START'
	          ),
	          _react2.default.createElement(
	            'button',
	            { className: this.props._toggleStopwatchButtonClassName('stop-button'),
	              onClick: this.props._handleStopClick },
	            'STOP'
	          ),
	          _react2.default.createElement(
	            'button',
	            { className: 'reset-button', onClick: this.props._handleResetClick },
	            'RESET'
	          )
	        )
	      );
